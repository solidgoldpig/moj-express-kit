...
let matchProp = require('./match-prop')
let getRouteHierarchy = require('./route-hierarchy')
...
router.get('/dump', (req, res) => {
  ...
  router.stack.forEach(r => {
    console.log('stack route', r.regexp.toString())
  })
  // console.log(router)
      ...
      routeHandler(routeInstance, Object.assign(
        ...
        .then(routeOutcome => {
          ...
          if (!errors && req.method === 'POST' && routeInstanceFinal.redirect && req.originalUrl !== routeInstanceFinal.redirect && req.body.updateForm !== 'yes') {
            ...
            if (!routeInstanceFinal.elements || !routeInstanceFinal.elements.length) {
